...
N = int(input("Enter the value of N in the N-Queens Problem: "))
...
while heuristicFunction(chessBoard, N, -1, -1) != 0:
    ...
    print("Heuristic value is:", heuristicFunction(chessBoard, N, -1, -1), "\n")
print("\nFollowing is the Global maxima solution for", N, "Queen Problem with heuristic distance from goal state =", heuristicFunction(chessBoard, N, -1, -1), "\n\n")
